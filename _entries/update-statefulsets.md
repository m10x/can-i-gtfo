...
description: "Update existing StatefulSets"
abuses:
  - type: "Container Escape"
    description: "Update pods to run with privileged access (BadPod) and escape container boundaries."
    resources:
      - "https://github.com/BishopFox/badPods"
  - type: "Lateral Movement"
    description: "Update pods to 
